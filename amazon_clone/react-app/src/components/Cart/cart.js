...
function Cart() {
    ...
    <div class="mx-auto max-w-3xl">
                ...
                <img className="checkout-ad border border-solid" src="https://images-na.ssl-images-amazon.com/images/G/01/Lutron/Amazon_Diva_Smart_Launch_Banner_1500x300_English.jpg"></img>
                <br></br>
                <div className="border border-solid text-xl flex items-center justify-around h-6">

                <NavLink to='/wish_list'>
                    <strong className="border border-solid bg-teal-400 "> View Your Wishlist</strong>
                </NavLink>
              

                <Link to='/prev_order'>
                    <strong className="border border-solid bg-teal-400 "> View Previous Orders</strong>
                </Link>
