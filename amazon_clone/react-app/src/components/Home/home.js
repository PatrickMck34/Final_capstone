        ...
        <div className="home">
            <div className="home-container">
                ...
                <div className="home-line">
                     ...
                     <Item id={1}title="Amazon Kindle Fire" price={219.99} image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSK2xs4CcvDoHUKifWct4HZXwQ7C-129lLBrDXaqqH6P-jqVjOD7lEsA_JjFpLey7DUEQ0&usqp=CAU'
                     rating={3}/> 
<<<<<<< HEAD
...
=======
                     ...
                     <Item id={2} title="KingTool 325 piece Home Repair Toolkit" price={89.99} image='https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSMIzb1QnMIefo_pgAguHcB7mW4-amOfwlGyX9XNnR69V2glGhU' 
                     rating={5}/>
                     

              <Item id={3} title="ASETY Demascus Knife Set 3PCS, NSF Food-Safe Kitchen Knife Set" price={267.00} image='https://i.postimg.cc/Zn2MLDYp/knife.jpg' 
                 rating={4}/> 
